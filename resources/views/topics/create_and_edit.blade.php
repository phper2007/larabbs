        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                	<label for="titie-field">Titie</label>
                	<input class="form-control" type="text" name="titie" id="titie-field" value="{{ old('titie', $topic->titie ) }}" />
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="user" id="user-field" value="{{ old('user', $topic->user ) }}" />
                </div> 
                <div class="form-group">
